...
Manualmente 
    ...
    2. Altere o arquivo index.php para que o caminho fique local
    ...
    3. Transfira o banco de dados

    4. Altere o arquivo .env para os dados do banco online

    5. Opcionalmente podemos limpar e recriar os caches ( se tivermos acesso )
